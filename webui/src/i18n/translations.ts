...
const EXACT_ZH_TO_EN: Record<string, string> = {
  ...
  "刷新": "Refresh",
  "刷新中...": "Refreshing...",
  "已批量创建 {{count}} 个订阅": "Created {{count}} subscriptions in batch",
  "保存配置": "Save Config",
  "保存规则": "Save Rule",
  "保存中...": "Saving...",
  "操作": "Actions",
  ...
  "订阅链接（每行一个）": "Subscription URLs (one per line)",
  ...
  "每行一个 http/https 订阅链接": "One http/https subscription URL per line",
  "至少填写一个 URL": "At least one URL is required",
